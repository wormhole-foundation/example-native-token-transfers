...
export interface MockWormholeEndpointContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GAS_LIMIT"
      | "consistencyLevel"
...
export interface MockWormholeEndpointContract extends BaseContract {
  connect(runner?: ContractRunner | null): MockWormholeEndpointContract;
  waitForDeployment(): Promise<this>;

  interface: MockWormholeEndpointContractInterface;
  ...
  ): TypedContractMethod<[newOwner: AddressLike], [void], "view">;
  getFunction(
