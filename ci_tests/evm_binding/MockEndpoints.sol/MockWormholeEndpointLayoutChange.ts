...
export interface MockWormholeEndpointLayoutChangeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GAS_LIMIT"
      | "consistencyLevel"
...
export interface MockWormholeEndpointLayoutChange extends BaseContract {
  connect(runner?: ContractRunner | null): MockWormholeEndpointLayoutChange;
  waitForDeployment(): Promise<this>;

  interface: MockWormholeEndpointLayoutChangeInterface;
  ...
  setData: TypedContractMethod<[], [void], "nonpayable">;
