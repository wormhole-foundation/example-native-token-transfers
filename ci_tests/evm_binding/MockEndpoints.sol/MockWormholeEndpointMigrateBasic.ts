...
export interface MockWormholeEndpointMigrateBasicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GAS_LIMIT"
      | "consistencyLevel"
...
export interface MockWormholeEndpointMigrateBasic extends BaseContract {
  connect(runner?: ContractRunner | null): MockWormholeEndpointMigrateBasic;
  waitForDeployment(): Promise<this>;

  interface: MockWormholeEndpointMigrateBasicInterface;
