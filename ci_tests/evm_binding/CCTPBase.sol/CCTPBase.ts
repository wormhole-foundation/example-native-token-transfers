...
export interface CCTPBaseInterface extends Interface {
  getFunction(
    nameOrSignature: "setRegisteredSender" | "wormhole" | "wormholeRelayer"
  ): FunctionFragment;
...
export interface CCTPBase extends BaseContract {
  connect(runner?: ContractRunner | null): CCTPBase;
