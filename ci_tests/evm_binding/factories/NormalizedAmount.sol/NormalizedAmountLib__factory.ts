...
export class NormalizedAmountLib__factory extends ContractFactory {
  ...
  ): NormalizedAmountLib__factory {
    return super.connect(runner) as NormalizedAmountLib__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): NormalizedAmountLibInterface {
    return new Interface(_abi) as NormalizedAmountLibInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as NormalizedAmountLib;
  }
}
