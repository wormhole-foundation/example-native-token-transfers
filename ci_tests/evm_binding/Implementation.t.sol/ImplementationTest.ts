...
export interface ImplementationTestInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "test_cantIncrementCounterDirectly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_cantInitializeDirectly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_cantInitializeDirectly2",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_cantMigrateExternally",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_cantUpgradeDirectly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initializeProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
