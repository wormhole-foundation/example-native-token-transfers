...
export interface MockWormholeTransceiverContractInterface
...
export interface MockWormholeTransceiverContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockWormholeTransceiverContractInterface;
