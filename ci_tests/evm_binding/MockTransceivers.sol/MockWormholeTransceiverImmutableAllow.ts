...
export interface MockWormholeTransceiverImmutableAllowInterface
...
export interface MockWormholeTransceiverImmutableAllow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockWormholeTransceiverImmutableAllowInterface;
