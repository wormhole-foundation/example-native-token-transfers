...
export interface UtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "test_doesntDisableInitializer()": FunctionFragment;
    "test_safeConstructor()": FunctionFragment;
    "test_writesToStorage()": FunctionFragment;
  };
...
export interface UtilsTest extends BaseContract {
  ...
  callStatic: {
    ...
    test_doesntDisableInitializer(overrides?: CallOverrides): Promise<void>;

    test_safeConstructor(overrides?: CallOverrides): Promise<void>;

    test_writesToStorage(overrides?: CallOverrides): Promise<void>;
  };
