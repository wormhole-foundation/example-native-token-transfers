...
export interface TestRelayerEndToEndManualInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
  ...
  encodeFunctionData(
    functionFragment: "test_relayerEndpointAuth",
    values?: undefined
  ): string;
...
export interface TestRelayerEndToEndManual extends BaseContract {
  connect(runner?: ContractRunner | null): TestRelayerEndToEndManual;
  waitForDeployment(): Promise<this>;

  interface: TestRelayerEndToEndManualInterface;
  ...
  test_relayerEndpointAuth: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_relayerEndpointAuth"
  ): TypedContractMethod<[], [void], "nonpayable">;
