...
export interface TestRelayerEndToEndManualInterface extends utils.Interface {
  functions: {
    ...
    "test_relayerTransceiverAuth()": FunctionFragment;
    "test_relayerWithInvalidWHTransceiver()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_relayerTransceiverAuth"
      | "test_relayerWithInvalidWHTransceiver"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_relayerTransceiverAuth",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_relayerWithInvalidWHTransceiver",
    values?: undefined
  ): string;
...
export interface TestRelayerEndToEndManual extends BaseContract {
  ...
  callStatic: {
    ...
    test_relayerTransceiverAuth(overrides?: CallOverrides): Promise<void>;
