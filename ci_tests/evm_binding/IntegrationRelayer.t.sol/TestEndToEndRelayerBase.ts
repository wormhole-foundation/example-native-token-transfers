...
export interface TestEndToEndRelayerBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
...
export interface TestEndToEndRelayerBase extends BaseContract {
  connect(runner?: ContractRunner | null): TestEndToEndRelayerBase;
  waitForDeployment(): Promise<this>;

  interface: TestEndToEndRelayerBaseInterface;
