...
export interface TestInitializeInterface extends utils.Interface {
  functions: {
    ...
    "test_cannotFrontrunInitialize()": FunctionFragment;
    "test_doubleInitialize()": FunctionFragment;
  };
...
export interface TestInitialize extends BaseContract {
  ...
  callStatic: {
    ...
    test_cannotFrontrunInitialize(overrides?: CallOverrides): Promise<void>;

    test_doubleInitialize(overrides?: CallOverrides): Promise<void>;
  };
