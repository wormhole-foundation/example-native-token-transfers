...
export interface TestInitializeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_cannotFrontrunInitialize"
      | "test_doubleInitialize"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_cannotFrontrunInitialize",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_doubleInitialize",
    values?: undefined
  ): string;
...
export interface TestInitialize extends BaseContract {
  connect(runner?: ContractRunner | null): TestInitialize;
  waitForDeployment(): Promise<this>;

  interface: TestInitializeInterface;
  ...
  test_cannotFrontrunInitialize: TypedContractMethod<[], [void], "nonpayable">;

  test_doubleInitialize: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_cannotFrontrunInitialize"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_doubleInitialize"
  ): TypedContractMethod<[], [void], "nonpayable">;
