...
export interface MockNttManagerContractInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "lastSlot", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "lastSlot", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "messageAttestations",
    data: BytesLike
  ): Result;
...
export interface MockNttManagerContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockNttManagerContractInterface;
  ...
  functions: {
    ...
    lastSlot(overrides?: CallOverrides): Promise<[string] & { result: string }>;
  ...
  lastSlot(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    lastSlot(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lastSlot(overrides?: CallOverrides): Promise<PopulatedTransaction>;
