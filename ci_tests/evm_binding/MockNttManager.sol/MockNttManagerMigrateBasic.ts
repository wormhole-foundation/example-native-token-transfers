...
export interface MockNttManagerMigrateBasicInterface extends utils.Interface {
  functions: {
...
export interface MockNttManagerMigrateBasic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockNttManagerMigrateBasicInterface;
