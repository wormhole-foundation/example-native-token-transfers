...
export interface DummyTransceiverInterface extends utils.Interface {
  functions: {
    ...
    "parseMessageFromLogs((bytes32[],bytes,address)[])": FunctionFragment;
...
export interface DummyTransceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DummyTransceiverInterface;
  ...
  functions: {
    ...
    ): Promise<[number, string] & { recipientChain: number; payload: string }>;
