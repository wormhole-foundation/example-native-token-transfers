...
export interface TestEndToEndBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
  ...
  encodeFunctionData(
    functionFragment: "test_lotsOfReverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_multiEndpoint",
    values?: undefined
  ): string;
...
export interface TestEndToEndBase extends BaseContract {
  connect(runner?: ContractRunner | null): TestEndToEndBase;
  waitForDeployment(): Promise<this>;

  interface: TestEndToEndBaseInterface;
  ...
  test_lotsOfReverts: TypedContractMethod<[], [void], "nonpayable">;

  test_multiEndpoint: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_lotsOfReverts"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_multiEndpoint"
  ): TypedContractMethod<[], [void], "nonpayable">;
