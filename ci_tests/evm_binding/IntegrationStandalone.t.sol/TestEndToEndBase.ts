...
export interface TestEndToEndBaseInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "encodeTransceiverInstruction(bool)": FunctionFragment;
    "encodeTransceiverInstructions(bool)": FunctionFragment;
    ...
    "test_lotsOfReverts()": FunctionFragment;
    "test_multiTransceiver()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_multiTransceiver",
    values?: undefined
  ): string;
...
export interface TestEndToEndBase extends BaseContract {
  ...
  callStatic: {
    ...
    test_lotsOfReverts(overrides?: CallOverrides): Promise<void>;

    test_multiTransceiver(overrides?: CallOverrides): Promise<void>;
  };
