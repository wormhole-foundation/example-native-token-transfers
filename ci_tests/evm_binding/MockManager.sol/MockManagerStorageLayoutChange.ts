...
export interface MockManagerStorageLayoutChangeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestationReceived"
      | "chainId"
...
export interface MockManagerStorageLayoutChange extends BaseContract {
  connect(runner?: ContractRunner | null): MockManagerStorageLayoutChange;
  waitForDeployment(): Promise<this>;

  interface: MockManagerStorageLayoutChangeInterface;
