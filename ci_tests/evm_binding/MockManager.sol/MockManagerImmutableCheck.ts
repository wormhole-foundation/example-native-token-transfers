...
export interface MockManagerImmutableCheckInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestationReceived"
      | "chainId"
...
export interface MockManagerImmutableCheck extends BaseContract {
  connect(runner?: ContractRunner | null): MockManagerImmutableCheck;
  waitForDeployment(): Promise<this>;

  interface: MockManagerImmutableCheckInterface;
