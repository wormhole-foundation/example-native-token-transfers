...
export interface MockManagerContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestationReceived"
      | "chainId"
...
export interface MockManagerContract extends BaseContract {
  connect(runner?: ContractRunner | null): MockManagerContract;
  waitForDeployment(): Promise<this>;

  interface: MockManagerContractInterface;
  ...
  lastSlot: TypedContractMethod<[], [string], "view">;
