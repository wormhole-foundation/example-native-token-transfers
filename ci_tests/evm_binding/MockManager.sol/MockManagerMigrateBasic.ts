...
export interface MockManagerMigrateBasicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestationReceived"
      | "chainId"
...
export interface MockManagerMigrateBasic extends BaseContract {
  connect(runner?: ContractRunner | null): MockManagerMigrateBasic;
  waitForDeployment(): Promise<this>;

  interface: MockManagerMigrateBasicInterface;
