...
export interface MockManagerImmutableRemoveCheckInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestationReceived"
      | "chainId"
...
export interface MockManagerImmutableRemoveCheck extends BaseContract {
  connect(runner?: ContractRunner | null): MockManagerImmutableRemoveCheck;
  waitForDeployment(): Promise<this>;

  interface: MockManagerImmutableRemoveCheckInterface;
