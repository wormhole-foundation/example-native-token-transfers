...
export interface OwnershipTestsInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "checkOwnership(address,address)": FunctionFragment;
    ...
    "testTransceiverOwnership()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testTransceiverOwnership",
    values?: undefined
  ): string;
...
export interface OwnershipTests extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnershipTestsInterface;
  ...
  callStatic: {
    ...
    testTransceiverOwnership(overrides?: CallOverrides): Promise<void>;
  };
