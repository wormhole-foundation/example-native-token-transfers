...
export interface OwnershipTestsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "checkOwnership"
  ...
  encodeFunctionData(
    functionFragment: "testEndpointOwnership",
    values?: undefined
  ): string;
...
export interface OwnershipTests extends BaseContract {
  connect(runner?: ContractRunner | null): OwnershipTests;
  ...
  checkOwnership: TypedContractMethod<
    [e: AddressLike, managerOwner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  testEndpointOwnership: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testEndpointOwnership"
  ): TypedContractMethod<[], [void], "nonpayable">;
