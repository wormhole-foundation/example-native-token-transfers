...
export interface TestEndpointStructsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_SerdeJunk_ManagerMessage"
      | "test_SerdeJunk_NativeTokenTransfer"
      | "test_SerdeRoundtrip_ManagerMessage"
      | "test_SerdeRoundtrip_NativeTokenTransfer"
      | "test_serialize_EndpointMessage"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_SerdeJunk_ManagerMessage",
  ...
  encodeFunctionData(
    functionFragment: "test_SerdeRoundtrip_ManagerMessage",
    values: [EndpointStructs.ManagerMessageStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_serialize_EndpointMessage",
    values?: undefined
  ): string;
...
export interface TestEndpointStructs extends BaseContract {
  connect(runner?: ContractRunner | null): TestEndpointStructs;
  waitForDeployment(): Promise<this>;

  interface: TestEndpointStructsInterface;
  ...
  test_SerdeJunk_ManagerMessage: TypedContractMethod<
    [m: EndpointStructs.ManagerMessageStruct],
    [void],
    "nonpayable"
  >;

  test_SerdeJunk_NativeTokenTransfer: TypedContractMethod<
    [m: EndpointStructs.NativeTokenTransferStruct],
    [void],
    "nonpayable"
  >;

  test_SerdeRoundtrip_ManagerMessage: TypedContractMethod<
    [m: EndpointStructs.ManagerMessageStruct],
    [void],
    "nonpayable"
  >;

  test_SerdeRoundtrip_NativeTokenTransfer: TypedContractMethod<
    [m: EndpointStructs.NativeTokenTransferStruct],
    [void],
    "nonpayable"
  >;

  test_serialize_EndpointMessage: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_SerdeJunk_ManagerMessage"
  ): TypedContractMethod<
    [m: EndpointStructs.ManagerMessageStruct],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "test_SerdeJunk_NativeTokenTransfer"
  ): TypedContractMethod<
    [m: EndpointStructs.NativeTokenTransferStruct],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "test_SerdeRoundtrip_ManagerMessage"
  ): TypedContractMethod<
    [m: EndpointStructs.ManagerMessageStruct],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "test_SerdeRoundtrip_NativeTokenTransfer"
  ): TypedContractMethod<
    [m: EndpointStructs.NativeTokenTransferStruct],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "test_serialize_EndpointMessage"
