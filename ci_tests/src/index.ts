...
async function test(chain1: ChainDetails, chain2: ChainDetails){
    ...
    */
    ...
    result = await manager2["transfer(uint256,uint16,bytes32,bool,bytes)"](amount, chain1.chainId, <BytesLike>addressToBytes(<string>"0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1"), false, "0x01000101"); // No relayer - actually works but don't know how to get info from the spy.
    var txResponse = await result.wait(); 
