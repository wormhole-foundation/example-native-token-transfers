...
contract RateLimiter is IRateLimiter {
    ...
    constructor(uint64 _rateLimitDuration, address _manager, uint8 _tokenDecimals) {
    ...
    function deleteOutboundQueuedTransfer(uint64 messageSequence) public onlyManager {
        delete _getOutboundQueueStorage()[messageSequence];
    }

    function deleteInboundQueuedTransfer(bytes32 digest) public onlyManager {
