...
/// @title NttManagerBase
/// @author Wormhole Project Contributors.
/// @notice The NttManager is the abstract contract responsible for managing the token
...
abstract contract NttManagerBase is INttManager, ManagerBase {
