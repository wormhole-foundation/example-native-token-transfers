...
contract WormholeEndpoint is Endpoint, IWormholeEndpoint, IWormholeReceiver {
    ...
    function _initializeEndpoint() internal {
        ...
        wormhole.publishMessage(0, EndpointStructs.encodeEndpointInit(init), CONSISTENCY_LEVEL);
    }
    ...
    function _setWormholeSibling(uint16 chainId, bytes32 siblingContract) internal {
        ...
        wormhole.publishMessage(
            0, EndpointStructs.encodeEndpointRegistration(registration), CONSISTENCY_LEVEL
        );
