...
contract TestManager is Test, IManagerEvents, IRateLimiterEvents {
    ...
    function setUp() public {
        ...
        Manager implementation =
            new MockManagerContract(address(t), IManager.Mode.LOCKING, chainId, 1 days);
    ...
    function test_noAutomaticSlot() public {
        DummyToken t = new DummyToken();
        MockManagerContract c = new MockManagerContract(address(t), IManager.Mode.LOCKING, 1, 1 days);
    ...
    function test_constructor() public {
        ...
        new MockManagerContract(address(t), IManager.Mode.LOCKING, 1, 1 days);
    ...
    function test_upgradeManager() public {
        ...
        MockManagerContract newManager =
            new MockManagerContract(manager.token(), IManager.Mode.LOCKING, chainId, 1 days);
