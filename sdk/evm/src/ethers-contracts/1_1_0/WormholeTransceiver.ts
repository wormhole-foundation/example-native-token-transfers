...
export interface WormholeTransceiverInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTransceiverType",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface WormholeTransceiver extends BaseContract {
  ...
  getTransceiverType: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "WORMHOLE_TRANSCEIVER_VERSION"
  ...
  getFunction(
    nameOrSignature: "getTransceiverType"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    ...
    "RelayingInfo(uint8,bytes32,uint256)": TypedContractEvent<
      RelayingInfoEvent.InputTuple,
      RelayingInfoEvent.OutputTuple,
      RelayingInfoEvent.OutputObject
    >;
